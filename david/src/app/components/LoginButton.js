  ...
  if (session) {
    return (
      <div className="flex flex-col items-center gap-4">
        ...
        <button
          onClick={() => signOut()}
          className="rounded-full border border-solid border-red-500 text-red-500 transition-colors flex items-center justify-center hover:bg-red-500 hover:text-white font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
        >
          로그아웃
        </button>
      </div>
